...
static String fallback_resources[] =
  ...
  "*controlForm*fontList:	-adobe-courier-bold-r-*-*-12-120-75-75-*-70-*-*",
  ...
  "*topLevelShell.title:		ncplot 4.11.3",
  ...
  "*pageFwd.recomputeSize:		false",
  "*pageBkd.recomputeSize:		false",
  "*pageFwd.width:			120",
  "*pageBkd.width:			120",
  "*pageFwd.height:			32",
  "*pageBkd.height:			32",
  ...
  "*menuBar*newData.labelString:	Open netCDF File",
  "*menuBar*newData.mnemonic:		O",
  "*menuBar*newData.accelerator:	Ctrl<Key>O",
  "*menuBar*newData.acceleratorText:	Ctrl-O",
   ...
   * Control window
   */
  "*controlForm*XmFrame.XmLabel.childHorizontalAlignment: ALIGNMENT_CENTER",
  "*controlForm*XmFrame.XmLabel.childVerticalAlignment:   ALIGNMENT_BASELINE_BOTTOM",
  "*controlForm*XmFrame.XmLabel.childHorizontalSpacing:   5",
  "*controlForm*XmFrame.XmLabel.childType:		FRAME_TITLE_CHILD",

  "*controlForm*XmFrame.shadowType:			SHADOW_IN",
  ...
  "*prefParmsShell.x:			250",
  "*prefParmsShell.y:			200",
  ...
  "*editParmsShell.x:			225",
  "*editParmsShell.y:			150",
  ...
  "*plRC*varFilter.columns:		14",
  "*plRC*varFilter.maxLength:		20",
